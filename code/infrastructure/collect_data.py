...
# Ca c'est le nombre de chandelier à la minute qu'on veut
CANDLE_COUNT = 3000

# On multiplie donc le nombre de chandelier minute par le facteur correpondant
INCREMENTS = {
    'M5' : 5* CANDLE_COUNT,
    'H1' : 60* CANDLE_COUNT,
    'H4' : 240* CANDLE_COUNT
...
def collect_data(pair, granularity, date_f, date_t, file_prefix, api: OandaApi):
    ...
    while to_date < end_date:
        ...
        if candles is not None:
            ...
            print(f"{pair} {granularity} {from_date} {to_date} --> NO_CANDLES")
